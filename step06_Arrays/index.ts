const fruitNames: string[] = ['Orange','Mango', 'Apple', 'Banana', 'Strawberry', 'Dates']
...
const subjectList : readonly string[] = ['Chemistry', 'Biology', 'Physics', 'Urdu', 'English']

// subjectList.push ('Computer Science'); //error


//changing the value of array
const colorList : string[] = ['Blue', 'Black', 'Red', 'Brown', 'Yellow', 'Peach']
...
const schoolNames : string[] = ['Al Shams Public secondary School', 'Uffaq School System', 'The City Clif School']
